  ...
  Future<void> loginWithQrPayload(String payload) async {
    ...
    try {
      ...
      throw const QrLoginException(
        'Backend terlalu lama merespons QR Login. Pastikan apipre.kitaundang.my.id dan Supabase sedang stabil, lalu coba QR baru.',
      );
    } catch (_) {
      throw const QrLoginException(
        'Tidak bisa terhubung ke backend. Pastikan apipre.kitaundang.my.id aktif dan mengarah ke server backend.',
      );
    }
